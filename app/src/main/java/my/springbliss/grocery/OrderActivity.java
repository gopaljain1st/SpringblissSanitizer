    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(this, ""+formattime, Toast.LENGTH_SHORT).show();
        ...
        while(c.moveToNext()){
            ...
            String z=item_image.replace("https://inventivepartner.com/Inventive_fruits/images/","");
               ...
               // Log.v("JsonData", "onClick: "+jsonData );
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                String url = "https://inventivepartner.com/Inventive_fruits/proceed_order.php";
