...
public class MyorderActivity extends AppCompatActivity {
    private static final String apiurl="https://inventivepartner.com/Inventive_fruits/history.php";
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            int amt= Integer.parseInt(total_amount)+30;
                            if(user_id.equals(personelid))
                            {
                                myorders.add(new Myorder(dateOfOrder,timmeOfOrder,orderid,order_status,item_count,""+amt));
